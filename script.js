...
buttons.innerHTML += `<input type="button"  class="first_btn" onclick="first()" value="First"/>`
...
buttons.innerHTML += `<input type="button"  class="prev_btn" onclick="previous()" value="Previous"/>`
buttons.innerHTML += `<input type="button"  class="last_btn" onclick="last()" value="Last"/>`
